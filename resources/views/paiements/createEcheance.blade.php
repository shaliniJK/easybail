    ...
    <div class="col-lg-9">
        ...
        <div class="card w-100">
            ...
            <div class="card-header">
                <h3 class="card-title">Envoyer un avis d'écheance de paiement</h3>
            </div>
            <div class="card-body">
                ...
                <form class="" method="POST" action="{{ route('paiements.notify', $location->id) }}">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col">
                                <button type="submit" class="btn btn-red">Envoyer l'avis</button>
                            </div>
                        </div>
                    </div>
                </form>
